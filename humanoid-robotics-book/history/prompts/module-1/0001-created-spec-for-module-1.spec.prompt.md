---
id: 0001
title: Created spec for module 1
stage: spec
date: 2025-12-07
surface: agent
...
user: unknown
command: /sp.phr --title "Created spec for module 1" --stage spec --feature "module-1"
...
<command-name>/sp.phr</command-name>
<command-args>--title "Created spec for module 1" --stage spec --feature "module-1"</command-args># COMMAND: Record this AI exchange as a structured PHR artifact
...
--title "Created spec for module 1" --stage spec --feature "module-1"
...
If the user provided a task/question in --title "Created spec for module 1" --stage spec --feature "module-1":
...
- `{{PROMPT_TEXT}}` → **THE COMPLETE --title "Created spec for module 1" --stage spec --feature "module-1" TEXT VERBATIM** (do NOT truncate to first line!)
...
**CRITICAL**: `{{PROMPT_TEXT}}` MUST be the FULL multiline user input from --title "Created spec for module 1" --stage spec --feature "module-1" above, not just the title or first line.
